...
//    />
      ...
      sampleEditText.setMaxLines(20);
      sampleEditText.setSingleLine(false);
      sampleEditText.setLayoutParams(new LinearLayout.LayoutParams(fill, wrap));


      layout.addView(sampleEditText);
      return parent;
    }
